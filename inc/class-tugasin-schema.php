...
class Tugasin_Schema
{
    ...
    public function maybe_output_schema()
    {
        ...
        $this->output_blogposting_schema();
    }
     ...
     *
     * Uses Schema.org BlogPosting type for blog articles.
     *
     * @since 2.20.0
     */
    private function output_blogposting_schema()
    {
        ...
        $content = get_the_content(null, false, $post_id);
        $excerpt = has_excerpt($post_id) ? get_the_excerpt($post_id) : wp_trim_words(wp_strip_all_tags($content), 30, '...');
