...
<section class="hero" style="padding: 140px 0 80px;">
    <div class="container" style="text-align: center; max-width: 800px;">
        ...
        <p style="font-size: 1.2rem; color: rgba(255,255,255,0.9);"><?php esc_html_e( 'Temukan panduan skripsi, tips belajar, dan informasi seputar dunia perkuliahan yang kamu butuhkan.', 'tugasin' ); ?></p>
    </div>
</section>
...
<section class="services" style="padding: 40px 0; background: var(--bg-body);">
    <div class="container">
        ...
        <div class="archive-filter-container" data-post-type="post" data-taxonomy="category" style="display: flex; gap: 16px; flex-wrap: wrap; justify-content: center; margin-bottom: 40px;">
            <?php
        ...
        <!-- Blog Grid -->
        <div id="archive-grid" class="services-grid" style="grid-template-columns: repeat(auto-fill, minmax(320px, 1fr));">
            <?php
            if ( have_posts() ) :
                while ( have_posts() ) :
                    the_post();
                ...
                <div class="no-posts" style="grid-column: 1 / -1; text-align: center; padding: 60px 20px;">
                    ...
                    <p style="color: var(--text-secondary);"><?php esc_html_e( 'Artikel akan segera hadir. Stay tuned!', 'tugasin' ); ?></p>
                </div>
                <?php
            endif;
            ?>
